...
#include <plat/devs.h>	/*add by Nick*/
#include <mach/regs-audss.h> /*add by Nick*/
...
static struct clksrc_clk *sysclks[] = {
	...
	&clk_sclk_audio2,
	&clk_sclk_spdif,
	&clk_mout_audss,	/*add by Nick*/
	&clk_mout_i2s_a,	/*add by Nick*/
	&clk_dout_audio_bus_clk_i2s,	/*add by Nick*/
};
